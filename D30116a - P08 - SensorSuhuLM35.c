...
====================================================================================
P08 - Pembacaan ADC sensor Suhu LM35 dengan Konversi ke Celsius.
  program untuk membaca nilai Analog sensor suhu
------------------------------------------------------------------------------------
Materi baru:
...
while (1)
      ...
      else if (data_Teg > 1.0 && data_Teg < 3.0)
         {
            PORTC.0 = 0;
            PORTC.1 = 1;
            PORTC.2 = 0;
